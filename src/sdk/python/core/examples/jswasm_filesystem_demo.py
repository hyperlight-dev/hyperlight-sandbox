"""Filesystem demo for the JS Wasm component backend (Python SDK)."""
...
sandbox = Sandbox(backend="wasm", module="javascript_guest.path", input_dir=input_dir)
...
sandbox = Sandbox(backend="wasm", module="javascript_guest.path", input_dir=input_dir, temp_output=True)
result = sandbox.run("""
...
sandbox = Sandbox(backend="wasm", module="javascript_guest.path", input_dir=input_dir, output_dir=output_dir)
result = sandbox.run("""
